...
export default async function ProfilePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <header>
        <h1 className="text-2xl font-bold flex items-center gap-2"><User className="w-5 h-5 text-brand-blue" /> Profil</h1>
      </header>
      ...
      <section className="card p-5">
        <h2 className="section-title mb-3 flex items-center gap-2"><Trophy className="w-4 h-4 text-warning" /> Badges ({badges.length})</h2>
        {badges.length === 0 ? (
